  ...
  return (
    <div className="max-w-2xl">
      ...
      <div className="flex flex-col gap-4">
        ...
        <PaymentGatewayCard
          title="PayU"
          description="From PayU Dashboard → My Account → Merchant Key & Salt. Uses PayU's signed hosted-checkout redirect. New — send yourself a test payment before relying on it for real orders."
